...
resource "aws_iam_role" "codebuild_role" {
  name = "grocellery-codebuild-role"
...
# Add policies to roles to allow access to S3, ECR, CodeCommit, etc.
# This is a simplified example. You would need more granular policies.

resource "aws_iam_role_policy_attachment" "codepipeline_policy" {
  role       = aws_iam_role.codepipeline_role.name
  policy_arn = "arn:aws:iam::aws:policy/AWSCodePipelineFullAccess" # Replace with a more restrictive policy
}

resource "aws_iam_role_policy_attachment" "codebuild_policy" {
  role       = aws_iam_role.codebuild_role.name
  policy_arn = "arn:aws:iam::aws:policy/AWSCodeBuildAdminAccess" # Replace with a more restrictive policy
}
