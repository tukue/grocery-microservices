...
- Use bounded backoff retries. Send records that exhaust consumer retries to the failed-letter topic and require explicit operator replay.
...
- Kafka consumers are idempotent and their retry behavior terminates safely in the failed-letter topic.
