...
import com.grocery.microservices.cart.config.JwtRequestFilter;
...
@ActiveProfiles("test")
@ImportAutoConfiguration(exclude = com.grocery.microservices.cart.config.SecurityConfig.class)
