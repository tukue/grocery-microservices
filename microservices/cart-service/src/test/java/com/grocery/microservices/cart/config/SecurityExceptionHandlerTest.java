...
class SecurityExceptionHandlerTest {
    ...
    void writesJsonUnauthorizedResponse() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/carts/1");
        ...
        assertEquals("/carts/1", body.get("path").asText());
    }

    @Test
    void writesJsonForbiddenResponse() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest("DELETE", "/carts/1");
        MockHttpServletResponse response = new MockHttpServletResponse();
